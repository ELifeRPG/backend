...
- [docs/world.md](./docs/world.md) — item instances: the grant path, join-time inventory reads, the spawn-acknowledgement delivery loop, and gathering
