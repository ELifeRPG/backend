...
// Companies no longer has its own ICurrentGameServer (deleted outright); Characters' and Shops' both
// survive, reshaped to resolve a durable GameServerId instead of keying tenancy.
