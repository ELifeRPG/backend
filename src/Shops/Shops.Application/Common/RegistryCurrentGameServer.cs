...
/// ARCHITECTURE.md §9e. Shops.Application already references Accounts.Application (declared
/// honestly in Shops.Application.csproj, not merely transitive) for this query.
